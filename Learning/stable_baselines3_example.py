...
env = StableBaselinesGodotEnv(env_path=args.env_path, show_window=args.viz, n_parallel=args.n_parallel, seed=args.seed,
                              speedup=args.speedup)
env = VecMonitor(env)

if args.resume_model_path is None:
    model = PPO("MultiInputPolicy", env, ent_coef=0.01, verbose=2, n_steps=128, learning_rate=2.5e-4, clip_range=0.1, vf_coef=0.5, n_epochs=4, batch_size=256, tensorboard_log=args.experiment_dir)
